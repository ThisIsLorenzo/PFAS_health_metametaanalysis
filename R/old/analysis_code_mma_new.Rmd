...
# custom function
source(here("function", "build_vcv_from_overlap.R"))
...
ggsave(here("figs/suppl","Supplementary Figure 1.png"),
       width = 6,
       height = 6)
```
...
source(here("function", "custom_logOR_new.R"))
...
```{r, include=FALSE, eval=FALSE}
ggsave(here("figs/suppl","Supplementary Figure 2.png"),
       width = 8,
       height = 8)
```
...
```{r, include=FALSE, eval=FALSE}
ggsave(here("figs/suppl","Supplementary Figure 3.png"),
       width = 8,
       height = 8)
```
...
```{r, include=FALSE, eval=FALSE}
ggsave(here("figs/suppl","Supplementary Figure 4.png"),
       width = 10,
       height = 14)
```
...
I2_lnH <- orchaRd::i2_ml(mod_overall_lnH)
...
source(here("function", "custom_lnH_new.R"))
...
save_as_docx(
  ft, 
  path = here("tabs", "PFAS_Health_Outcomes_Table_new.docx")
)
```
...
# Save the plot
ggsave(here("figs/suppl","Supplementary Figure 6.png"), 
       plot = forest_plot, 
       width = 8, height = 6, 
       dpi = 300)
...
ggsave(here("figs/suppl","Supplementary Figure 5.png"), 
       plot = combined_plot, 
       width = 12, height = 10, 
       dpi = 300)
